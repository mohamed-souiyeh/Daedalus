...
export async function addKeyboardEventListners(controlCenterButton: HTMLButtonElement, pauseButton: HTMLButtonElement, debugButton: HTMLButtonElement, numberInput: HTMLInputElement) {
